...
function onGeoError(){
 ...
 function gosearch(event){
    if(searchtitle.value == ""){
        ...
        if(select.value == 'NAVER'){
            event.preventDefault();
            location.href = `https://search.naver.com/search.naver?sm=tab_hty.top&where=nexearch&query=${searchtitle.value}`;
        }
 ...
 function go_gmail(event){
    event.preventDefault();
    location.href = 'https://mail.google.com/';
 }

 function go_nmail(event){
    event.preventDefault();
    location.href = 'https://mail.naver.com/';
 }

const NMAIL = document.querySelector("#Nmail");
const GMAIL = document.querySelector("#Gmail");
NMAIL.addEventListener('click',go_nmail);
GMAIL.addEventListener('click',go_gmail);